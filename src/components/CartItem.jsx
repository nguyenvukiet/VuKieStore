...
const CartItem = props => {
    ...
    //hàm update sản phẩm trong giỏ hàng khai báo trong cartItemsSlice
    ...
    // hàm xóa sản phẩm ra khỏi giỏ hàng khai báo trong cartItemsSlice
  ...
  return (
    <div className="cart__item" ref={itemRef}>
        <div className="cart__item__image">
            <img src = {props.item.product.image01} alt="Hình ảnh sản phảm"/>
        </div>
